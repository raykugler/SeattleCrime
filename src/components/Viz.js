...
class Viz extends Component {
 ...
 show_one=()=>{
    ...
    let single_hood_name_text= document.createTextNode(this.props.top_chosen_array[0]);
...
setTimeout(this.twoHood_display,500);
    ...
    twoHood_display = () =>{
        ...
        let first_hood_name_text= document.createTextNode(this.props.top_chosen_array[0]);
            first_hood_name_title.appendChild(first_hood_name_text);

        let second_hood_name_text= document.createTextNode(this.props.bottom_chosen_array[0]);
...
put_table_here.appendChild(two_hood_table);
    ...
    let two_hood_object = {
      ...
      render(){
        return <div id='data_display_id' className='viz_holder'> 
        <nav className='viz_nav'>
        <img src={table} alt='chart' className='table_button'/>
        <img src={pie} alt='chart' className='pie_button'/>
